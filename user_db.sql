...
-- Dumping data for table user_db.categories: ~5 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `category` varchar(50) COLLATE armscii8_bin NOT NULL,
  `image` varbinary(50) NOT NULL,
  PRIMARY KEY (`product_id`),
  UNIQUE KEY `product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Dumping data for table user_db.products: ~5 rows (approximately)
INSERT INTO `products` (`product_id`, `product_name`, `quantity`, `price`, `category`, `image`) VALUES
	(1, 'Marlboro', 600, 37000, 'Cigarettes', _binary 0x70726f647563745f342e706e67),
	(2, 'Sampoerna', 500, 32000, 'Cigarettes', _binary 0x70726f647563745f332e6a7067),
	(3, 'Sprite', 500, 3500, 'Beverages', _binary 0x70726f647563745f322e706e67),
	(4, 'Coca_cola', 500, 3500, 'Beverages', _binary 0x70726f647563745f312e706e67),
	(5, 'Stella', 500, 31000, 'Household', _binary 0x70726f647563745f352e706e67);
...
-- Dumping data for table user_db.user_form: ~2 rows (approximately)
